...
void loop() {
  //String s = Serial.readString(); //Read the serial data and store in var
  ...
  if(Serial.available()) {
    ...
    char p = Serial.read();
    //Serial.print(p);
    if(player1 == false && p == 0/*p.equals("p1clicked\n")*/) {
      player1 = true;
      ...
      i--;
    } else if(player1 == true && player2 == true && p == 2/*p.equals("p1\n")*/) {
        lcd.clear();
        player1Row++;
        if(player1Row % 15 == 0){
          player1Lap++;
